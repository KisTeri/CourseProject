...
namespace AccountingOfStudents.Migrations
{
    ...
    [Migration("20230401111903_Migration_1.3.0")]
    partial class Migration_130
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AccountingOfStudents.Entities.InformationAboutEducation", b =>
                {
                    ...
                    b.Property<int>("AssignedCategory")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AccountingOfStudents.Entities.InformationAboutEducation", b =>
                {
                    b.HasOne("AccountingOfStudents.Entities.AssignedCategory", "AssignedCategories")
                        ...
                        .HasForeignKey("AssignedCategory")
